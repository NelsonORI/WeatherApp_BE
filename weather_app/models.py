...
class WeatherForecast(db.Model):
    ...
    high_temp = db.Column(db.String(50))
    low_temp = db.Column(db.String(50))
    condition = db.Column(db.String(100))
    rain_percentage = db.Column(db.String(50))
...
class TodayWeather(db.Model):
    ...
    highest_temp = db.Column(db.String(50))
    lowest_temp = db.Column(db.String(50))
    wind_speed = db.Column(db.String(50))
    humidity = db.Column(db.String(50))
    dew_point = db.Column(db.String(50))
    pressure = db.Column(db.String(50))
    uv_index = db.Column(db.String(50))
